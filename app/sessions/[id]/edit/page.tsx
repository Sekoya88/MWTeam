  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const payload: any = {
        ...
        isKeySession: formData.isKeySession,
      }
    ...
    <Layout>
      <div className="max-w-4xl mx-auto animate-fade-in">
        <div className="mb-6">
          ...
          <h1 className="text-4xl font-bold text-black mb-2">Modifier la séance</h1>
          <p className="text-gray-600">Mettez à jour les informations de votre séance</p>
        </div>

        <Card className="shadow-medium">
          <CardHeader>
            <CardTitle>Informations de la séance</CardTitle>
            <CardDescription>Modifiez les détails de votre entraînement</CardDescription>
          </CardHeader>
          <CardContent>
