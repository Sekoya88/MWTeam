 ...
 * 
 * Seeds the RAG database with all 20 DMFD structured chunks from the
 * demi-fond training knowledge base + expert rules.
 * 
 * This runs server-side on Cloud Run with direct DB access.
 * Auth: x-admin-key header must match ADMIN_SECRET_KEY or HUGGINGFACE_API_KEY.
 */
...
// All 20 DMFD chunks + expert-800m-rules
// Based on docs/training-knowledge/RAG_DemiFond_Unifie.pdf
// and docs/training-knowledge/RAG_DemiFond_Architecture_GCP.pdf
const DMFD_CHUNKS = [
    {
